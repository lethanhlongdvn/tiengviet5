        ...
        "211-ltvc-gio-hoa-thang-nam": {
            ...
            "tabs": {
                "lesson": {
                    "title": "Bài học",
                    "blocks": [
                        { "type": "header", "text": "CÁCH NỐI CÁC VẾ CÂU GHÉP (Tiếp theo)" },
                        {
                            "type": "html",
                            "content": `<div class="mb-8">
                                <h4 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                                    <span class="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center mr-3 text-sm font-black">1</span>
                                    Tìm cặp kết từ nối các vế câu trong mỗi câu ghép dưới đây:
                                </h4>
                                <div class="space-y-4">
                                    <!-- Câu a -->
                                    <div id="ltvc21_q1a" data-ans="Bởi,nên" class="p-4 bg-white rounded-xl shadow-sm border border-gray-100 transition-all">
                                        <p class="text-lg leading-loose text-gray-700 font-medium mb-2">
                                            a. <span class="word" onclick="toggleWord(this)">Bởi</span> <span class="word" onclick="toggleWord(this)">tôi</span> <span class="word" onclick="toggleWord(this)">ăn</span> <span class="word" onclick="toggleWord(this)">uống</span> <span class="word" onclick="toggleWord(this)">điều</span> <span class="word" onclick="toggleWord(this)">độ</span> <span class="word" onclick="toggleWord(this)">và</span> <span class="word" onclick="toggleWord(this)">làm</span> <span class="word" onclick="toggleWord(this)">việc</span> <span class="word" onclick="toggleWord(this)">có</span> <span class="word" onclick="toggleWord(this)">chừng</span> <span class="word" onclick="toggleWord(this)">mực</span> <span class="word" onclick="toggleWord(this)">nên</span> <span class="word" onclick="toggleWord(this)">tôi</span> <span class="word" onclick="toggleWord(this)">chóng</span> <span class="word" onclick="toggleWord(this)">lớn</span> <span class="word" onclick="toggleWord(this)">lắm.</span>
                                        </p>
                                        <p class="text-right text-gray-500 italic text-sm">(Tô Hoài)</p>
                                        <div class="flex gap-2 mt-2">
                                            <button onclick="ltvc21_check1('ltvc21_q1a')" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg text-sm transition-colors">Kiểm tra</button>
                                            <button onclick="ltvc21_reset1('ltvc21_q1a')" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-lg text-sm transition-colors">Làm lại</button>
                                        </div>
                                    </div>
                                    <!-- Câu b -->
                                    <div id="ltvc21_q1b" data-ans="Mặc dù,nhưng" class="p-4 bg-white rounded-xl shadow-sm border border-gray-100 transition-all">
                                        <p class="text-lg leading-loose text-gray-700 font-medium mb-2">
                                            b. <span class="word" onclick="toggleWord(this)">Mặc dù</span> <span class="word" onclick="toggleWord(this)">chúng</span> <span class="word" onclick="toggleWord(this)">tôi</span> <span class="word" onclick="toggleWord(this)">vẫn</span> <span class="word" onclick="toggleWord(this)">chơi</span> <span class="word" onclick="toggleWord(this)">với</span> <span class="word" onclick="toggleWord(this)">nhau</span> <span class="word" onclick="toggleWord(this)">nhưng</span> <span class="word" onclick="toggleWord(this)">thời</span> <span class="word" onclick="toggleWord(this)">gian</span> <span class="word" onclick="toggleWord(this)">Pam</span> <span class="word" onclick="toggleWord(this)">dành</span> <span class="word" onclick="toggleWord(this)">cho</span> <span class="word" onclick="toggleWord(this)">tôi</span> <span class="word" onclick="toggleWord(this)">không</span> <span class="word" onclick="toggleWord(this)">còn</span> <span class="word" onclick="toggleWord(this)">nhiều</span> <span class="word" onclick="toggleWord(this)">như</span> <span class="word" onclick="toggleWord(this)">trước.</span>
                                        </p>
                                        <p class="text-right text-gray-500 italic text-sm">(Theo Minh Hương)</p>
                                        <div class="flex gap-2 mt-2">
                                            <button onclick="ltvc21_check1('ltvc21_q1b')" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg text-sm transition-colors">Kiểm tra</button>
                                            <button onclick="ltvc21_reset1('ltvc21_q1b')" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-lg text-sm transition-colors">Làm lại</button>
                                        </div>
                                    </div>
                                    <!-- Câu c -->
                                    <div id="ltvc21_q1c" data-ans="Nếu,thì" class="p-4 bg-white rounded-xl shadow-sm border border-gray-100 transition-all">
                                        <p class="text-lg leading-loose text-gray-700 font-medium mb-2">
                                            c. <span class="word" onclick="toggleWord(this)">Nếu</span> <span class="word" onclick="toggleWord(this)">hoa</span> <span class="word" onclick="toggleWord(this)">mua</span> <span class="word" onclick="toggleWord(this)">có</span> <span class="word" onclick="toggleWord(this)">màu</span> <span class="word" onclick="toggleWord(this)">tím</span> <span class="word" onclick="toggleWord(this)">hồng</span> <span class="word" onclick="toggleWord(this)">thì</span> <span class="word" onclick="toggleWord(this)">hoa</span> <span class="word" onclick="toggleWord(this)">sim</span> <span class="word" onclick="toggleWord(this)">tím</span> <span class="word" onclick="toggleWord(this)">nhạt,</span> <span class="word" onclick="toggleWord(this)">phơn</span> <span class="word" onclick="toggleWord(this)">phớt</span> <span class="word" onclick="toggleWord(this)">như</span> <span class="word" onclick="toggleWord(this)">má</span> <span class="word" onclick="toggleWord(this)">con</span> <span class="word" onclick="toggleWord(this)">gái.</span>
                                        </p>
                                        <p class="text-right text-gray-500 italic text-sm">(Băng Sơn)</p>
                                        <div class="flex gap-2 mt-2">
                                            <button onclick="ltvc21_check1('ltvc21_q1c')" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg text-sm transition-colors">Kiểm tra</button>
                                            <button onclick="ltvc21_reset1('ltvc21_q1c')" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-lg text-sm transition-colors">Làm lại</button>
                                        </div>
                                    </div>
                                </div>
                            </div>`
                        },
                        {
                            ...
                            "content": `<div class="mb-8">
                                <h4 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                                    <span class="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center mr-3 text-sm font-black">2</span>
                                    <span>Chọn cặp từ (<i>đâu ... đó ...; chưa ... đã ...; bao nhiêu ... bấy nhiêu ...</i>) thay cho bông hoa.</span>
                                </h4>
                                <div class="space-y-4">
                                     <!-- Câu a -->
                                     <div id="ltvc21_q2a" data-ans="chưa-đã" class="p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                                        <div class="flex flex-col md:flex-row gap-4 items-center justify-between mb-2">
                                            <p class="text-lg text-gray-700 font-medium flex-grow">
                                                a. Ngày <span class="slot text-blue-500">✿</span> tắt hẳn, trăng <span class="slot text-blue-500">✿</span> lên rồi.
                                            </p>
                                            <select onchange="ltvc21_update2('ltvc21_q2a', this.value)" class="px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none">
                                        ...
                                        <p class="text-right text-gray-500 italic text-sm mb-2">(Theo Thạch Lam)</p>
                                        <button onclick="ltvc21_check2('ltvc21_q2a')" class="w-full py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 font-bold rounded-lg transition-colors">Kiểm tra</button>
                                     </div>
                                     <!-- Câu b -->
                                     <div id="ltvc21_q2b" data-ans="đâu-đấy" class="p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                                        <div class="flex flex-col md:flex-row gap-4 items-center justify-between mb-2">
                                            <p class="text-lg text-gray-700 font-medium flex-grow">
                                                b. Trăng đi đến <span class="slot text-blue-500">✿</span>, lũy tre được tắm đẫm màu sữa đến <span class="slot text-blue-500">✿</span>.
                                            </p>
                                            <select onchange="ltvc21_update2('ltvc21_q2b', this.value)" class="px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none">
                                                <option value="">-- Chọn --</option>
                                                <option value="đâu-đấy">đâu ... đấy</option>
                                                <option value="chưa-đã">chưa ... đã</option>
                                                <option value="bao nhiêu-bấy nhiêu">bao nhiêu ... bấy nhiêu</option>
                                            </select>
                                        </div>
                                        <p class="text-right text-gray-500 italic text-sm mb-2">(Theo Phan Sĩ Châu)</p>
                                        <button onclick="ltvc21_check2('ltvc21_q2b')" class="w-full py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 font-bold rounded-lg transition-colors">Kiểm tra</button>
                                     </div>
                                     <!-- Câu c -->
                                     <div id="ltvc21_q2c" data-ans="bao nhiêu-bấy nhiêu" class="p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                                        <div class="flex flex-col md:flex-row gap-4 items-center justify-between mb-2">
                                            <p class="text-lg text-gray-700 font-medium flex-grow">
                                                c. Nước dâng lên cao <span class="slot text-blue-500">✿</span>, Sơn Tinh lại làm cho đồi, núi mọc cao lên <span class="slot text-blue-500">✿</span>.
                                            </p>
                                            <select onchange="ltvc21_update2('ltvc21_q2c', this.value)" class="px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none">
                                                <option value="">-- Chọn --</option>
                                                <option value="bao nhiêu-bấy nhiêu">bao nhiêu ... bấy nhiêu</option>
                                                <option value="càng-càng">càng ... càng</option>
                                                <option value="vừa-đã">vừa ... đã</option>
                                            </select>
                                        </div>
                                        <p class="text-right text-gray-500 italic text-sm mb-2">(Truyện Sơn Tinh, Thủy Tinh)</p>
                                        <button onclick="ltvc21_check2('ltvc21_q2c')" class="w-full py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 font-bold rounded-lg transition-colors">Kiểm tra</button>
                                     </div>
                                </div>
                            </div>`
                        },
                        {
                            "type": "html",
                            "content": `<div class="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-r-lg shadow-sm mb-8 relative">
                                <div class="absolute -left-3 top-4">
                                     <span class="text-3xl">📎</span>
                                </div>
                                <h3 class="text-xl font-black text-gray-800 mb-3 pl-4">Ghi nhớ</h3>
                                <div class="pl-4 text-gray-800 leading-relaxed font-medium">
                                    <p class="mb-2">Các vế của câu ghép có thể nối với nhau bằng các cặp từ:</p>
                                    <ul class="list-disc list-outside ml-5 space-y-2">
                                        <li>
                                            Các cặp kết từ: 
                                            <i>vì ... nên ...; bởi ... nên ...; nhờ ... nên (mà) ...; nếu ... thì ...; hễ ... thì ...; giá ... thì ...; tuy ... nhưng ...; mặc dù ... nhưng ...; dù ... nhưng ...; chẳng những ... mà ...; không chỉ ... mà ...;...</i>
                                        </li>
                                        <li>
                                            Các cặp từ hô ứng: 
                                            <i>vừa ... đã ...; chưa ... đã ...; càng ... càng ...; đâu ... đó ...; bao nhiêu ... bấy nhiêu ...;...</i>
                                        </li>
                                    </ul>
                                </div>
                            </div>`
                        },
                        {
                            ...
                            "content": `<div class="mb-8">
                                <h4 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                                    <span class="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center mr-3 text-sm font-black">3</span>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="p-4 bg-white/60 rounded-xl flex flex-col gap-4">
                                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                            <p class="text-lg font-bold text-gray-700 flex-1">
                                                a. Vào dịp lễ Mừng xuân, chẳng những trẻ em được vui đùa thoả thích mà <span class="text-blue-500">✿</span>.
                                            </p>
                                            <div class="flex gap-2 w-full sm:w-auto items-center">
                                                <input type="text" id="ai-3a" placeholder="Viết tiếp vế câu..." class="flex-1 sm:w-72 px-5 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none text-base">
                                                <button onclick="askAI('3a', 'Vào dịp lễ Mừng xuân, chẳng những trẻ em được vui đùa thoả thích mà')" class="btn btn-success w-12 h-12 flex items-center justify-center rounded-lg text-sm font-black shadow-md">✓</button>
                                            </div>
                                        </div>
                                        <div class="ai-feedback hidden p-4 bg-green-50 text-green-800 text-base rounded-lg" id="fb-3a"></div>
                                    </div>
                                    <!-- Câu b -->
                                     <div class="p-4 bg-white/60 rounded-xl flex flex-col gap-4">
                                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                            <p class="text-lg font-bold text-gray-700 flex-1">
                                                b. Mặc dù thiên nhiên khắc nghiệt nhưng <span class="text-blue-500">✿</span>.
                                            </p>
                                            <div class="flex gap-2 w-full sm:w-auto items-center">
                                                <input type="text" id="ai-3b" placeholder="Viết tiếp vế câu..." class="flex-1 sm:w-72 px-5 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none text-base">
                                                <button onclick="askAI('3b', 'Mặc dù thiên nhiên khắc nghiệt nhưng')" class="btn btn-success w-12 h-12 flex items-center justify-center rounded-lg text-sm font-black shadow-md">✓</button>
                                            </div>
                                        </div>
                                        <div class="ai-feedback hidden p-4 bg-green-50 text-green-800 text-base rounded-lg" id="fb-3b"></div>
                                    </div>
                                    <!-- Câu c -->
                                     <div class="p-4 bg-white/60 rounded-xl flex flex-col gap-4">
                                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                            <p class="text-lg font-bold text-gray-700 flex-1">
                                                c. Nhờ bố kể những câu chuyện cổ tích mà <span class="text-blue-500">✿</span>.
                                            </p>
                                            <div class="flex gap-2 w-full sm:w-auto items-center">
                                                <input type="text" id="ai-3c" placeholder="Viết tiếp vế câu..." class="flex-1 sm:w-72 px-5 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none text-base">
                                                <button onclick="askAI('3c', 'Nhờ bố kể những câu chuyện cổ tích mà')" class="btn btn-success w-12 h-12 flex items-center justify-center rounded-lg text-sm font-black shadow-md">✓</button>
                                            </div>
                                        </div>
                                        <div class="ai-feedback hidden p-4 bg-green-50 text-green-800 text-base rounded-lg" id="fb-3c"></div>
                                    </div>
                                </div>
                            </div>`
                        },
                        {
                            ...
                            "content": `<div class="mb-8">
                                <h4 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                                    <span class="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center mr-3 text-sm font-black">4</span>
                                    Đặt câu ghép theo các yêu cầu sau:
                                </h4>
                                <div class="space-y-4">
                                    <div class="p-4 bg-white/60 rounded-xl flex flex-col gap-4">
                                        <p class="text-lg font-bold text-gray-700">a. Một câu ghép sử dụng một trong các cặp kết từ: <i>vì ... nên ..., bởi ... nên ..., nhờ ... nên (mà) ...</i></p>
                                        <div class="flex gap-2 w-full items-center">
                                            <input type="text" id="ai-4a" placeholder="Đặt câu của em..." class="flex-1 px-5 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none text-base">
                                            <button onclick="askAI('4a', 'Đặt câu ghép với cặp từ chỉ nguyên nhân kết quả')" class="btn btn-success w-12 h-12 flex items-center justify-center rounded-lg text-sm font-black shadow-md">✓</button>
                                        </div>
                                        <div class="ai-feedback hidden p-4 bg-green-50 text-green-800 text-base rounded-lg" id="fb-4a"></div>
                                    </div>
                                     <div class="p-4 bg-white/60 rounded-xl flex flex-col gap-4">
                                        <p class="text-lg font-bold text-gray-700">b. Một câu ghép sử dụng một trong các cặp kết từ: <i>nếu ... thì ..., hễ ... thì ..., giá ... thì ...</i></p>
                                        <div class="flex gap-2 w-full items-center">
                                            <input type="text" id="ai-4b" placeholder="Đặt câu của em..." class="flex-1 px-5 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none text-base">
                                            <button onclick="askAI('4b', 'Đặt câu ghép với cặp từ chỉ điều kiện kết quả')" class="btn btn-success w-12 h-12 flex items-center justify-center rounded-lg text-sm font-black shadow-md">✓</button>
                                        </div>
                                        <div class="ai-feedback hidden p-4 bg-green-50 text-green-800 text-base rounded-lg" id="fb-4b"></div>
                                    </div>
                                    <div class="p-4 bg-white/60 rounded-xl flex flex-col gap-4">
                                        <p class="text-lg font-bold text-gray-700">c. Một câu ghép sử dụng một trong các cặp từ hô ứng: <i>vừa ... đã ..., càng ... càng ...</i></p>
                                        <div class="flex gap-2 w-full items-center">
                                            <input type="text" id="ai-4c" placeholder="Đặt câu của em..." class="flex-1 px-5 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none text-base">
                                            <button onclick="askAI('4c', 'Đặt câu ghép với cặp từ hô ứng')" class="btn btn-success w-12 h-12 flex items-center justify-center rounded-lg text-sm font-black shadow-md">✓</button>
                                        </div>
                                        <div class="ai-feedback hidden p-4 bg-green-50 text-green-800 text-base rounded-lg" id="fb-4c"></div>
                                    </div>
                                </div>
                            </div>`
                        }
                ...
                "quiz": {
                    ...
                    "questions": [
                        ...
                        { "q": "Tham khảo: 'Vì bạn Nam tích cực luyện tập nên...'", "a": ["bạn ấy đã giành giải nhất.", "bạn ấy bị mệt.", "bạn ấy đi ngủ sớm.", "bạn ấy không đi học."], "c": 0 },
        ...
        <div class="p-4 bg-white border-t border-gray-100">
            ...
            <div class="mt-4 flex justify-center border-t pt-4">
                ...
                "quiz": {
                    ...
                    "questions": [
                        {
                            "q": "Khi bạn đưa ra ý kiến khác mình, em nên làm gì?",
                            "a": ["Ngắt lời bạn ngay lập tức.", "Lắng nghe và tôn trọng sự khác biệt.", "Tỏ thái độ khó chịu.", "Bỏ đi chỗ khác."],
                            "c": 1
                        },
                        {
                            "q": "Thái độ đúng mực nhất khi tham gia thảo luận là gì?",
                            "a": ["Cố gắng thắng bằng mọi giá.", "Giữ im lặng từ đầu đến cuối.", "Cầu thị, lắng nghe và hòa nhã.", "Chỉ nghe những người đồng ý với mình."],
                            "c": 2
                        },
                        {
                            "q": "Nếu em cảm thấy ý kiến của bạn chưa hợp lý, em nên:",
                            "a": ["Chê bai ý kiến đó là dở.", "Đưa ra phản biện một cách lịch sự.", "Cười nhạo bạn.", "Bảo các bạn khác không nghe bạn đó nữa."],
                            "c": 1
                        },
                        {
                            "q": "Việc lắng nghe người khác giúp ích gì cho cuộc thảo luận?",
                            "a": ["Làm mất thời gian.", "Để tìm ra điểm yếu của bạn.", "Hiểu rõ vấn đề và tìm ra điểm thống nhất.", "Để làm hài lòng thầy cô."],
                            "c": 2
                        },
                        {
                            "q": "Khi có nhiều ý kiến trái chiều, mục tiêu của thảo luận là:",
                            "a": ["Tìm ra ai là người giỏi nhất.", "Thống nhất các ý kiến hoặc hiểu rõ sự khác biệt.", "Ép buộc mọi người theo một ý duy nhất.", "Kết thúc cuộc nói chuyện càng nhanh càng tốt."],
                            "c": 1
                        },
                        {
                            "q": "Khi phát biểu ý kiến, em cần nói với âm lượng thế nào?",
                            "a": ["Nói thật to để át tiếng người khác.", "Nói vừa đủ nghe, rõ ràng.", "Nói thật nhỏ để không ai nghe thấy.", "Nói càng nhanh càng tốt."],
                            "c": 1
                        },
                        {
                            "q": "Cụm từ nào dưới đây thể hiện sự tôn trọng khi bắt đầu phản biện?",
                            "a": ["Cậu sai rồi, nghe tớ đây...", "Ý kiến đó chán quá...", "Tớ hiểu ý cậu, nhưng tớ có một góc nhìn khác là...", "Đừng nói nữa, ý tớ mới đúng..."],
                            "c": 2
                        },
                        {
                            "q": "Trong thảo luận nhóm, chúng ta nên xưng hô như thế nào?",
                            "a": ["Xưng hô tùy tiện.", "Dùng đại từ phù hợp (Tớ - Cậu, Mình - Bạn).", "Không cần xưng hô.", "Gọi tên kèm theo biệt danh xấu."],
                            "c": 1
                        },
                        {
                            "q": "Khi trình bày một ý kiến tán thành, em nên kèm theo điều gì để thuyết phục?",
                            "a": ["Một lời đe dọa.", "Lý do và dẫn chứng cụ thể.", "Lời nói to tiếng.", "Sự im lặng."],
                            "c": 1
                        },
                        {
                            "q": "Nếu em muốn thay đổi ý kiến của mình sau khi nghe bạn giải thích, em nên:",
                            "a": ["Cứ giữ khư khư ý cũ để không bị \"mất mặt\".", "Thừa nhận bạn có lý và tiếp thu ý kiến hay.", "Tức giận với bạn.", "Không thảo luận nữa."],
                            "c": 1
                        },
                        {
                            "q": "Trong lúc nghe bạn trình bày, em cần làm gì?",
                            "a": ["Làm việc riêng.", "Ghi chép những thông tin đáng chú ý.", "Nhìn ra ngoài cửa sổ.", "Chuẩn bị sẵn câu để mắng bạn."],
                            "c": 1
                        },
                        {
                            "q": "Vai trò của người điều hành cuộc thảo luận là:",
                            "a": ["Chỉ định ai được nói và tóm tắt nội dung.", "Áp đặt ý kiến cá nhân lên cả nhóm.", "Ngồi chơi và quan sát.", "Quyết định ai thắng ai thua."],
                            "c": 0
                        },
                        {
                            "q": "Sau khi thảo luận xong, bước quan trọng nhất là:",
                            "a": ["Đi về ngay.", "Tóm tắt các điểm thống nhất và khác biệt.", "Cãi nhau xem ai nói nhiều hơn.", "Quên hết những gì vừa nói."],
                            "c": 1
                        },
                        {
                            "q": "Khi chuẩn bị ý kiến cho chủ đề \"Học sinh giữ tiền riêng\", em cần:",
                            "a": ["Chỉ tìm lý do tán thành.", "Chỉ tìm lý do phản đối.", "Tìm hiểu cả hai mặt của vấn đề.", "Không cần chuẩn bị gì."],
                            "c": 2
                        },
                        {
                            "q": "Để ghi chép hiệu quả khi thảo luận, em nên:",
                            "a": ["Viết lại từng từ bạn nói.", "Chỉ ghi những từ khóa và ý chính.", "Vẽ bậy vào sổ ghi chép.", "Ghi lại những lỗi sai của bạn để cười."],
                            "c": 1
                        },
                        {
                            "q": "Bạn Minh Trí đưa ra ý kiến trái ngược với em, em sẽ:",
                            "a": ["Coi Minh Trí không còn là bạn.", "Lắng nghe và đặt câu hỏi để hiểu tại sao bạn nghĩ thế.", "Bảo Minh Trí im lặng.", "Nói xấu bạn với người khác."],
                            "c": 1
                        },
                        {
                            "q": "Nếu cuộc thảo luận trở nên căng thẳng, em nên làm gì?",
                            "a": ["Quát to hơn để mọi người im lặng.", "Nhắc lại mục tiêu tôn trọng sự khác biệt và bình tĩnh lại.", "Khóc.", "Rời khỏi nhóm."],
                            "c": 1
                        },
                        {
                            "q": "Một người tham gia thảo luận tích cực là người:",
                            "a": ["Nói liên tục không cho ai nói.", "Biết lắng nghe và đóng góp ý kiến xây dựng.", "Không bao giờ đưa ra ý kiến.", "Luôn đồng ý với tất cả mọi người."],
                            "c": 1
                        },
                        {
                            "q": "Khi tóm tắt ý kiến của người khác, em cần:",
                            "a": ["Thêm thắt những điều họ không nói.", "Trình bày trung thực và khách quan ý của họ.", "Cắt xén bớt ý của họ cho xấu đi.", "Chỉ tóm tắt ý của mình."],
                            "c": 1
                        },
                        {
                            "q": "Tại sao cần có \"Những ý kiến khác biệt\" trong cuộc sống?",
                            "a": ["Để chúng ta cãi nhau nhiều hơn.", "Để chúng ta nhìn nhận vấn đề từ nhiều góc độ và toàn diện hơn.", "Để làm cuộc sống rắc rối thêm.", "Vì ai cũng muốn mình là người đặc biệt."],
                            "c": 1
                        }
                    ]
                }
        ...
        "221-ltvc": {
            ...
            "tabs": {
                        ...
                        <div class="space-y-4 text-gray-700">
                            ...
                            <div class="p-5 border border-orange-100 rounded-2xl bg-white shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 transition-all hover:border-orange-200" id="q2a" data-ans="Nếu-thì">
                                ...
                                <div class="flex gap-3 shrink-0 w-full sm:w-auto">
                                    <select class="flex-1 sm:w-52 p-3 rounded-xl border-2 border-gray-100 text-base font-bold bg-gray-50 focus:ring-4 focus:ring-orange-100 focus:border-orange-400 focus:bg-white focus:outline-none transition-all cursor-pointer" onchange="ltvc22_update2('q2a', this.value)">
                                        ...
                                        <option value="Hễ-là">Hễ... là...</option>
                                    </select>
                                    <button onclick="ltvc22_check2('q2a')" class="btn btn-warning w-10 h-10 flex items-center justify-center rounded-xl font-black shadow-lg transition-all">✓</button>
                                </div>
                            </div>
                            <!-- Câu 2b -->
                            <div class="p-5 border border-orange-100 rounded-2xl bg-white shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 transition-all hover:border-orange-200" id="q2b" data-ans="Mặc dù-nhưng">
                                ...
                                <div class="flex gap-3 shrink-0 w-full sm:w-auto">
                                    <select class="flex-1 sm:w-52 p-3 rounded-xl border-2 border-gray-100 text-base font-bold bg-gray-50 focus:ring-4 focus:ring-orange-100 focus:border-orange-400 focus:bg-white focus:outline-none transition-all cursor-pointer" onchange="ltvc22_update2('q2b', this.value)">
                                        <option value="">-- Chọn cặp từ --</option>
                                        <option value="Nếu-thì">Nếu... thì...</option>
                                        <option value="Mặc dù-nhưng">Mặc dù... nhưng...</option>
                                        <option value="Bởi vì-cho nên">Bởi vì... cho nên...</option>
                                        <option value="Chẳng những-mà">Chẳng những... mà...</option>
                                    </select>
                                    <button onclick="ltvc22_check2('q2b')" class="btn btn-warning w-10 h-10 flex items-center justify-center rounded-xl font-black shadow-lg transition-all">✓</button>
                                </div>
                            </div>
                             <!-- Câu 2c -->
                            <div class="p-5 border border-orange-100 rounded-2xl bg-white shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 transition-all hover:border-orange-200" id="q2c" data-ans="càng-càng">
                                ...
                                <div class="flex gap-3 shrink-0 w-full sm:w-auto">
                                    <select class="flex-1 sm:w-52 p-3 rounded-xl border-2 border-gray-100 text-base font-bold bg-gray-50 focus:ring-4 focus:ring-orange-100 focus:border-orange-400 focus:bg-white focus:outline-none transition-all cursor-pointer" onchange="ltvc22_update2('q2c', this.value)">
                                        <option value="">-- Chọn cặp từ --</option>
                                        <option value="vừa-đã">vừa... đã...</option>
                                        <option value="càng-càng">càng... càng...</option>
                                        <option value="đâu-đó">đâu... đó...</option>
                                        <option value="mới-đã">mới... đã...</option>
                                    </select>
                                    <button onclick="ltvc22_check2('q2c')" class="btn btn-warning w-10 h-10 flex items-center justify-center rounded-xl font-black shadow-lg transition-all">✓</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-[24px] p-6 shadow-lg border-l-8 border-purple-500 mt-8 API-box">
                        ...
                        <div class="space-y-4">
                             <div class="p-6 bg-white rounded-2xl border border-purple-100 shadow-sm flex flex-col gap-5">
                                ...
                                <div class="ai-feedback hidden p-6 bg-purple-50 text-purple-800 rounded-2xl border border-purple-100" id="fb-3"></div>
                            </div>
                        </div>
                    </div>`
                        }
                ...
                "quiz": {
                    "settings": { "pick": 10 },
                    "questions": [
                        { "q": "Cặp từ 'nhưng' trong đoạn văn (a) dùng để làm gì?", "a": ["Nối hai vế câu ghép", "Nối hai câu đơn", "Nối hai từ đơn", "Làm chủ ngữ"], "c": 0 },
                        { "q": "Cách nối các vế câu ghép trong câu (2) đoạn văn (a) là gì?", "a": ["Dùng từ nối", "Dùng cặp kết từ", "Dùng cặp từ hô ứng", "Nối trực tiếp (dấu phẩy)"], "c": 3 },
                        { "q": "Câu nào sau đây là câu ghép nối bằng cặp từ hô ứng?", "a": ["Lan đi học.", "Thỏ vừa đặt chân xuống nước đã vội co chân lên.", "Vì trời mưa nên Lan nghỉ.", "Tuy rét nhưng Lan vẫn đi."], "c": 1 },
                        { "q": "Điền cặp từ: '... em có một khu vườn rộng ... em sẽ trồng thật nhiều loại cây.'", "a": ["Nếu... thì...", "Vì... nên...", "Tuy... nhưng...", "Chẳng những... mà..."], "c": 0 },
                        { "q": "Cặp từ 'càng... càng...' biểu thị quan hệ gì?", "a": ["Tương phản", "Tăng tiến", "Nguyên nhân", "Điều kiện"], "c": 1 },
                        { "q": "Trong câu ghép 'Thỏ cố khều nhưng đưa chân không tới', vế 2 nối với vế 1 bằng từ nào?", "a": ["Vừa", "Và", "Nhưng", "Đã"], "c": 2 },
                        { "q": "Tìm cặp từ hô ứng phù hợp: 'Mưa ... to, gió ... thổi mạnh.'", "a": ["Nếu... thì...", "Càng... càng...", "Vì... nên...", "Mặc dù... nhưng..."], "c": 1 },
        ...
        "222-viet": {
            ...
            "tabs": {
                "lesson": {
                    "title": "Bài viết",
                    "blocks": [
                        { "type": "header", "text": "Viết bài văn tả người" },
                        {
                            "type": "html",
                            "content": "<div class='space-y-8 font-nunito'><!-- Phần 1: Chọn Đề --><section class='space-y-4'><h2 class='text-2xl font-black text-blue-800 flex items-center gap-2'><span class='bg-teal-500 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm'>1</span>Chọn đề bài</h2><div class='grid grid-cols-1 gap-6'><button onclick='viet222_selectTopic(1)' id='viet222-topic-1' class='viet222-topic-btn group relative p-8 rounded-[32px] border-4 border-gray-100 hover:border-teal-400 transition-all text-left bg-blue-50 hover:bg-blue-100'><div class='absolute top-6 right-6 text-6xl opacity-50'>👀</div><h3 class='text-4xl font-black text-gray-800 mb-4'>Đề 1: Người mới gặp</h3><p class='text-gray-700 text-2xl font-medium'>Tả một người em chỉ gặp một vài lần nhưng nhớ mãi.</p><div class='check-icon mt-4 hidden inline-block px-4 py-2 bg-teal-500 text-white font-bold text-lg rounded-full'>Đã chọn ✓</div></button><button onclick='viet222_selectTopic(2)' id='viet222-topic-2' class='viet222-topic-btn group relative p-8 rounded-[32px] border-4 border-gray-100 hover:border-teal-400 transition-all text-left bg-pink-50 hover:bg-pink-100'><div class='absolute top-6 right-6 text-6xl opacity-50'>🎭</div><h3 class='text-4xl font-black text-gray-800 mb-4'>Đề 2: Nhân vật phim/kịch</h3><p class='text-gray-700 text-2xl font-medium'>Tả nhân vật chính trong phim/kịch mà em đã xem.</p><div class='check-icon mt-4 hidden inline-block px-4 py-2 bg-teal-500 text-white font-bold text-lg rounded-full'>Đã chọn ✓</div></button></div><div id='viet222-badge' class='hidden text-center'><span class='px-4 py-1 bg-teal-100 text-teal-700 rounded-full font-bold text-sm'>Đã chọn đề bài</span></div></section><!-- Phần 2: Viết Bài --><section id='viet222-p2' class='space-y-6 opacity-50 pointer-events-none grayscale transition-all duration-500'><h2 class='text-2xl font-black text-blue-800 flex items-center gap-2'><span class='bg-teal-500 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm'>2</span>Thực hành viết</h2><div class='bg-yellow-50 p-6 rounded-[24px] border border-yellow-200 shadow-sm'><label class='block text-yellow-800 font-bold text-lg mb-2'>🌅 Mở bài</label><textarea id='viet222-mb' rows='3' class='w-full p-4 rounded-xl border-2 border-yellow-300 focus:outline-none focus:border-yellow-500 text-lg bg-white' placeholder='Giới thiệu người định tả...'></textarea></div><div class='bg-blue-50 p-6 rounded-[24px] border border-blue-200 shadow-sm space-y-4'><label class='block text-blue-800 font-bold text-lg'>📖 Thân bài</label><textarea id='viet222-tb' rows='10' class='w-full p-4 rounded-xl border-2 border-blue-200 mt-1 focus:outline-none focus:border-blue-500 bg-white' placeholder='Tả chi tiết về ngoại hình, tính cách, hoạt động...'></textarea></div><div class='bg-green-50 p-6 rounded-[24px] border border-green-200 shadow-sm'><label class='block text-green-800 font-bold text-lg mb-2'>❤️ Kết bài</label><textarea id='viet222-kb' rows='3' class='w-full p-4 rounded-xl border-2 border-green-300 focus:outline-none focus:border-green-500 text-lg bg-white' placeholder='Cảm nghĩ của em...'></textarea></div><!-- Image Upload --><div class='bg-indigo-50 p-6 rounded-[24px] border border-indigo-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4'><div class='flex-1'><label class='block text-indigo-800 font-bold text-lg mb-1'>📷 Nộp ảnh chụp bài làm (nếu không nhập máy)</label><p class='text-sm text-indigo-600'>Em có thể viết ra giấy rồi chụp ảnh nộp cho thầy nhé!</p></div><div class='relative'><input type='file' id='viet222-file' accept='image/*' capture='environment' class='hidden' onchange='document.getElementById(\"file-status\").innerText = \"✅ Đã chọn ảnh: \" + this.files[0].name; document.getElementById(\"file-status\").classList.remove(\"hidden\")'><label for='viet222-file' class='cursor-pointer bg-white text-indigo-600 font-bold py-3 px-6 rounded-xl border-2 border-indigo-300 hover:bg-indigo-50 transition-all flex items-center gap-2 shadow-sm'><span class='text-2xl'>📸</span> Chọn / Chụp Ảnh</label></div></div><div id='file-status' class='hidden text-center text-green-600 font-bold bg-green-50 p-2 rounded-lg border border-green-200'></div><div class='text-center'><button id='viet222-submit-btn' onclick='viet222_submit()' class='bg-gradient-to-r from-orange-400 to-orange-600 text-white font-black text-xl py-3 px-10 rounded-full shadow-lg hover:scale-105 transition-transform'>NỘP BÀI CHẤM ĐIỂM</button></div></section><!-- Phần 3: Kết quả --><section id='viet222-result' class='hidden'><div class='bg-white rounded-[30px] p-8 shadow-xl border-4 border-indigo-100 text-center'><h3 class='text-2xl font-black text-indigo-600 mb-6'>KẾT QUẢ ĐÁNH GIÁ</h3><div class='flex flex-col items-center justify-center mb-6'><span class='text-6xl font-black text-indigo-600' id='viet222-score'></span><div id='viet222-stars' class='text-3xl text-yellow-400 mt-2 gap-1 flex'></div></div><div class='grid grid-cols-1 md:grid-cols-2 gap-4 text-left'><div class='bg-green-50 p-4 rounded-xl border border-green-200'><h4 class='font-bold text-green-700 mb-1'>Điểm mạnh</h4><div id='viet222-feedback-good' class='text-gray-700 text-sm'></div></div><div class='bg-orange-50 p-4 rounded-xl border border-orange-200'><h4 class='font-bold text-orange-700 mb-1'>Góp ý</h4><div id='viet222-feedback-bad' class='text-gray-700 text-sm'></div></div></div><div class='mt-6 text-center'><button onclick='window.location.reload()' class='text-gray-400 text-xs font-bold uppercase tracking-widest hover:text-blue-500'>Làm lại bài khác</button></div></div></section></div>",
                        }
                    ]
                },
                "quiz": {
                    "settings": { "pick": 10 },
                    "questions": [
                        { "q": "Bài văn tả người thường có mấy phần?", "a": ["2 phần: Mở bài, Thân bài", "3 phần: Mở bài, Thân bài, Kết bài", "1 phần duy nhất", "4 phần: Mở bài, Thân bài, Kết bài, Bài học"], "c": 1 },
                        { "q": "Mở bài dùng để làm gì?", "a": ["Tả chi tiết ngoại hình", "Giới thiệu người định tả", "Nêu cảm nghĩ về người đó", "Kể chuyện về người đó"], "c": 1 },
                        { "q": "Khi tả ngoại hình, em nên chú ý điều gì?", "a": ["Tả tất cả mọi thứ", "Chỉ tả quần áo", "Chọn tả những đặc điểm nổi bật nhất", "Chỉ tả khuôn mặt"], "c": 2 },
                        { "q": "Để bài văn sinh động, em nên dùng biện pháp nghệ thuật nào?", "a": ["Liệt kê", "So sánh và Nhân hóa", "Viết câu ngắn", "Lặp lại từ ngữ"], "c": 1 },
                        { "q": "Tính cách của người được tả thể hiện qua đâu?", "a": ["Chỉ qua lời nói", "Chỉ qua ngoại hình", "Qua lời nói, cử chỉ, hành động", "Qua trang phục"], "c": 2 },
                        { "q": "Kết bài dùng để làm gì?", "a": ["Nêu tình cảm, suy nghĩ về người được tả", "Giới thiệu tên tuổi", "Tả hoạt động", "Kể lại kỷ niệm"], "c": 0 },
                        { "q": "Câu nào dưới đây có hình ảnh so sánh?", "a": ["Bà em năm nay 60 tuổi.", "Tóc bà bạc trắng như cước.", "Bà thường kể chuyện cho em nghe.", "Bà rất yêu thương em."], "c": 1 },
                        { "q": "Từ nào sau đây gợi tả vóc dáng?", "a": ["Hiền lành", "Vui vẻ", "Dong dỏng", "Thông minh"], "c": 2 },
                        { "q": "Mở bài gián tiếp là như thế nào?", "a": ["Giới thiệu ngay người định tả", "Nói một chuyện khác để dẫn vào giới thiệu người định tả", "Không giới thiệu gì cả", "Chỉ nói tên người đó"], "c": 1 },
                        { "q": "Khi tả hoạt động của em bé, chi tiết nào phù hợp?", "a": ["Đôi mắt sáng long lanh", "Tập đi lẫm chẫm", "Mái tóc đen nhánh", "Làn da trắng hồng"], "c": 1 },
                        { "q": "Kết bài mở rộng thường có nội dung gì?", "a": ["Chỉ kết thúc câu chuyện", "Bình luận thêm, mở rộng ý nghĩa", "Lặp lại mở bài", "Tả lại ngoại hình"], "c": 1 },
                        { "q": "Chi tiết 'khuôn mặt trái xoan' tả về bộ phận nào?", "a": ["Dáng người", "Khuôn mặt", "Đôi mắt", "Mái tóc"], "c": 1 },
                        { "q": "Để tả người mẹ đang nấu cơm, em nên quan sát bằng những giác quan nào?", "a": ["Chỉ bằng mắt", "Chỉ bằng mũi", "Bằng mắt, tai, mũi (ngửi mùi thơm)...", "Không cần quan sát"], "c": 2 },
                        { "q": "Tình cảm của em đối với người được tả cần như thế nào?", "a": ["Chân thật, sâu sắc", "Hời hợt", "Giả tạo", "Bình thường"], "c": 0 },
                        { "q": "Bước cuối cùng quan trọng sau khi viết xong bài văn là gì?", "a": ["Nộp ngay lập tức", "Đọc lại và sửa lỗi (soát lỗi)", "Viết lại bài mới", "Đi chơi"], "c": 1 }
                    ]
                }
            }
        }
                                ...
                                <div class="bg-white rounded-3xl shadow-xl overflow-hidden border-4 border-blue-100">
                                    ...
                                    <div class="p-4 bg-white border-t border-gray-100">
                                        <div class="flex gap-2 relative">
                                            ...
                                            <button onclick="nvn222_send()" 
                                                class="absolute right-2 top-2 bottom-2 bg-blue-600 hover:bg-blue-700 text-white px-6 rounded-xl font-bold transition-transform active:scale-95 shadow-lg shadow-blue-200 flex items-center gap-2">
                                                <span>Gửi</span>
