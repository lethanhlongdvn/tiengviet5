                ...
                "lesson": {
                    ...
                    "blocks": [
                        ...
                        },
                        {
                            "type": "html",
                            "content": `
    <div class="glass-card rounded-[24px] p-6 shadow-lg border-t-4 border-purple-400 mt-8">
        <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
            <span class="text-2xl">⭐</span> Tự đánh giá bài làm
        </h3>
        <div class="space-y-4 mb-6">
            <div class="star-group flex flex-col md:flex-row md:items-center justify-between bg-white p-4 rounded-xl border border-gray-100 shadow-sm" data-row="1">
                <span class="font-medium text-gray-700 mb-2 md:mb-0">Bài có đủ 3 phần (Mở/Thân/Kết)?</span>
                <div class="flex gap-2">
                    <button onclick="rateStar(this, 1)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 2)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 3)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 4)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 5)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                </div>
            </div>
            <div class="star-group flex flex-col md:flex-row md:items-center justify-between bg-white p-4 rounded-xl border border-gray-100 shadow-sm" data-row="2">
                <span class="font-medium text-gray-700 mb-2 md:mb-0">Có sử dụng hình ảnh so sánh?</span>
                <div class="flex gap-2">
                    <button onclick="rateStar(this, 1)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 2)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 3)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
            ...
            <div class="star-group flex flex-col md:flex-row md:items-center justify-between bg-white p-4 rounded-xl border border-gray-100 shadow-sm" data-row="3">
                <span class="font-medium text-gray-700 mb-2 md:mb-0">Không mắc lỗi chính tả?</span>
                <div class="flex gap-2">
                    <button onclick="rateStar(this, 1)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 2)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
                    <button onclick="rateStar(this, 3)" class="star-btn text-3xl text-gray-300 hover:text-yellow-400 transition-colors">★</button>
        ...
        <button onclick="submitLesson221VietData()" class="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-black py-4 rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transform active:scale-95 transition-all text-xl flex items-center justify-center gap-3">
